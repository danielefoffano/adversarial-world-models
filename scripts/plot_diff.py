...
files = ["./logs/Hopper-v3/default_2024-11-21-17:57:35_seed0/all_fric_avg_returns_robust.csv",
         ...
         "./logs/Hopper-v3/default_2024-11-21-17:57:35_seed0/all_friction_avg_returns-3.csv"
         ]
...
files_mass = ["./logs/Hopper-v3/default_2024-11-21-17:57:35_seed0/avg_returns_robust.csv",
         ...
         "./logs/Hopper-v3/default_2024-11-21-17:57:35_seed0/all_mass_avg_returns-3.csv",
         ]
...
plt.ylabel("Cumul Return", fontsize=12)
...
# Show plot
plt.tight_layout()
plt.savefig("./logs/Hopper-v3/default_2024-11-21-17:57:35_seed0/Compare_friction_all_agents_test.pdf")
...
# Show plot
plt.tight_layout()
plt.savefig("./logs/Hopper-v3/default_2024-11-21-17:57:35_seed0/Compare_mass_all_agentsz_test.pdf")